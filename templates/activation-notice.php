...
<div id="message" class="updated woocommerce-message wc-connect woocommerce-subscriptions-activated">
	<div class="squeezer">
		<h4>
			...
			echo wp_kses( sprintf( __( '%1$sWooCommerce Subscriptions Gifting Installed%2$s &#8211; %3$sYour customers can now buy subscriptions for others!%4$s', 'woocommerce-subscriptions-gifting' ), '<strong>', '</strong>', '<em>', '</em>' ), array( 'strong' => true, 'em' => true ) );
			?>
		</h4>
